...
RSpec.describe TopicsController, type: :controller do
  ...
  context "member user" do
    before do
      user = User.create!(name: "blather User", email: "user@blather.com", password: "helloworld", role: :member)
      create_session(user)
    end
  ...
  context "admin user" do
    before do
      user = User.create!(name: "blather User", email: "user@blather.com", password: "helloworld", role: :admin)
      create_session(user)
    end
